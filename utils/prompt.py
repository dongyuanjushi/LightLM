...
#
# template = {
#     "source": "user_{} has purchased {}. Predict what else will be bought by the user? ",
#     "target": "{}",
#     "input_first": "user",
#     "task": "direct_straightforward",
#     "id": "5-1"
# }

template = {
    "source": "Given the user_{}, predict which item will be bought by the user? ",
    "target": "{}",
    "input_first": "user",
    "task": "direct_straightforward",
    "id": "5-1"
...
# template = {
#     "source": "Which item will you recommend for user_{}? ",
#     "target": "{}",
#     "input_first": "user",
#     "task": "direct_straightforward",
#     "id": "5-2"
...
# template = {
#     "source": "What should we recommend for user_{} ?",
#     "target": "{}",
#     "input_first": "user",
#     "task": "direct_straightforward",
#     "id": "5-1"
...
# template = {
#     "source": "Which recommendation should we provide to user_{} ?",
#     "target": "{}",
#     "input_first": "user",
#     "task": "direct_straightforward",
#     "id": "5-2"
...
# template = {}
# template["source"] = "What item will be helpful for user_{} ?"
# template["target"] = "{}"
# template["input_first"] = "user"
# template["task"] = "direct_straightforward"
# template["id"] = "5-5"
...
# template = {}
# template["source"] = "What item would user_{} be likely to purchase? "
# template["target"] = "{}"
# template["input_first"] = "user"
# template["task"] = "direct_straightforward"
# template["id"] = "5-6"
...
# template[
#     "source"
# ] = "By analyzing the user_{} 's purchase, what item is expected to be bought? "
# template["target"] = "{}"
# template["input_first"] = "user"
# template["task"] = "direct_straightforward"
# template["id"] = "5-7"
...
# template[
#     "source"
# ] = "What is the item that could be recommended for user_{} ?"
# template["target"] = "{}"
# template["input_first"] = "user"
# template["task"] = "direct_straightforward"
# template["id"] = "5-8"
...
# template[
#     "source"
# ] = "Can you recommend the item for user_{} , given the user 's purchase? "
# template["target"] = "{}"
# template["input_first"] = "user"
# template["task"] = "direct_straightforward"
# template["id"] = "5-9"
...
template = {
    "source": "I need to know which user made the below comment for item_{} : {} . Can you help me find the user ?",
    "target": "{}",
    "input_first": "item",
    "task": "review",
    "id": "11-6"
...
# =====================================================
# Task Subgroup 12 -- Straight-forward -- 5 Prompts
# =====================================================
task_subgroup_12 = []
...
task_subgroup_12.append(template)
